...
/**
 * Human-readable display helpers for playback statistics (codecs, resolution,
 * frame rate, bitrate, dynamic range, profile/level).
 *
...
public class VideoMetadataUtils {
  ...
  public static @Nullable String getDynamicRangeDisplayName(
      @Nullable String sampleMimeType, @Nullable ColorInfo colorInfo) {
  ...
  public static @Nullable String getCodecProfileLevelDisplayString(
      @Nullable String sampleMimeType, int profile, int level) {
    if (TextUtils.isEmpty(sampleMimeType)) {
      return null;
    }
